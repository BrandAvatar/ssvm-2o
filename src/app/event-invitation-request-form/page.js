...
export default function EventInvitationRequestForm() {
    return (
        <>
        ...
        <div className=" p-0 p-lg-5">
          <div className="section__header">
            <h3 className="d-flex text-lg-center text-start gap-3 justify-content-center align-items-center">
             <img src="https://ssvmtransformationindia.s3.ap-south-1.amazonaws.com/images/ele.webp" alt="" className='strike' /> Event Invitation Request Form
            </h3>
            ...
            {/* <p className='mt-lg-2'><b>Last date to apply: </b>20th June</p>
            <p className='mt-lg-2'><b>Eligibility: </b>Only students from SSVM institutions are eligible to apply.</p>
